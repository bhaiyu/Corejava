...
public class DataUtility {
	...
	private static final SimpleDateFormat appTimeFormatter = new SimpleDateFormat(
			TIME_FORMAT);
	...
	public static Timestamp getTime(String val) {
		Timestamp timeStamp = null;
		try {
			timeStamp = new Timestamp((appTimeFormatter.parse(val)).getTime());
		} catch (Exception e) {
			return null;
		}
		return timeStamp;
	...
	public static void main(String[] args) {
		Timestamp timestamp = getTime("2014-09-29 19:23:29.0");
