...
public class UserModelJDBCImpl implements UserModelInt {
	...
	public void delete(UserDTO dto)throws ApplicationException{
		...
		try{
			...
			throw new ApplicationException("Execption : Exception in delete user");
		}finally{
			JDBCDataSource.closeConnection(conn);
		}
		log.debug("Model delete Started");
	...
	public List search(UserDTO dto, int pageNo, int pageSize)
		...
		try {
			...
			throw new in.co.sunrays.ocha.exception.ApplicationException(
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			log.error("Database Exception..", e);
			throw new ApplicationException(
					"Exception : Exception in getting list of users"+e.getMessage());
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
	...
	public long registerUser(UserDTO dto) throws ApplicationException,
		...
		// String message = EmailBuilder.getUserRegistretionMessage(map);
		EmailMessage msg = new EmailMessage();
